...
def test_q_em():
    ...
    print("Tests passed!")
    tiny2 = MDP([0, 1, 2, 3], ['b', 'c'], tiny_transition, tiny_reward, 1.0)
    print("5.3.A", q_em(tiny2, 0, 'b', 0))
    print("5.3.B", q_em(tiny2, 0, 'b', 1))
    print("5.3.C", q_em(tiny2, 0, 'b', 2))
...
test_acc_sign_rnn(acc_sign_rnn)
